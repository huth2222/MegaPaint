...
namespace MegaPaint.Controllers.Entity.Product
{
    public class CategoryController : Controller
    {
        ...
        [Obsolete]
        public CategoryController(ContextDB context, IHostingEnvironment hostingEnvironment)
        {
            _db = context;
        ...
        [HttpPost]
        public IActionResult Index([FromForm] MP_ProductCategory model, [FromForm] string form_type)
        {
