document.addEventListener('DOMContentLoaded', function () {
    ...
    const mouseUpHandler = function () {
        ...
        table.querySelectorAll('tr').forEach(function (row) {
            ...
            //alert("th"+draggingColumnIndex.toString());
            // alert(draggingColumnIndex + '' + endColumnIndex);
            var inputs = document.getElementsByClassName("thtable");

            alert(inputs[0].id + "-" + inputs[0].value);
            // let attr = [];
            // let ids = [];
            ...
            //         //inputs[2].Value = 1;
            //         setTimeout(() => {
            //             document.getElementsByClassName("thtable")[2].value = "1";
            //         }, 100);
                
                //inputs[i].Value = inputs[i].id;
               // ids.push(inputs[i].id.toString());
            //    attr.push(i);
            //}
            //return false;
            //document.getElementsByClassName("thtable")[2].value = '2';
   

// alert(ids);
            //alert(document.getElementById("th2").Val);
            // document.getElementById("th"+draggingColumnIndex).value = endColumnIndex;
            // document.getElementById("th"+endColumnIndex).value = draggingColumnIndex;
